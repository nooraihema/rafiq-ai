// 1. الاستيراد الصحيح في بداية الملف (هذه هي الطريقة الحديثة والمضمونة)
import { GoogleGenerativeAI } from "https://unpkg.com/@google/generative-ai?module";

// تم إزالة غلاف "DOMContentLoaded" بالكامل، وبدأنا الكود مباشرة
...
const RafiqBrain = {
    ...
    getGenerativeResponse: async (message, userName) => {
        // بما أننا قمنا بالاستيراد في بداية الملف، لم نعد بحاجة للوصول إليه من "window"
        try {
...
// --- 5. UI Helper Functions (تبقى كما هي) ---
